...
RU: dict[str, str] = {
    ...
    "Registration successful! You can now log in.": "Регистрация прошла успешно! Теперь вы можете войти.",
    "Registration failed. Please try again.": "Ошибка при регистрации. Попробуйте снова.",
    "Logged out": "Выход выполнен",
    "Comment text cannot be empty": "Текст комментария не может быть пустым",
    ...
    "Invalid email/username or password": "Неверная почта/логин или пароль",
    ...
    # ── Empty states ──
    "No saved posts": "Нет сохранённых постов",
    "No notifications": "Нет уведомлений",
    "No chats yet": "Нет сообщений",
    "No followers yet": "Пока нет подписчиков",
    "No comments yet. Be the first!": "Комментариев пока нет. Будьте первым!",
    "User has no posts yet": "Пользователь ещё не написал ни одного поста",
    # ── Auth ──
    ...
    "Loading...": "Загрузка...",
    "has no posts yet": "пока нет постов",
    "No new notifications": "Нет новых уведомлений",
    "All notifications": "Все уведомления",
    "Error loading chats": "Ошибка загрузки чатов",
    "to leave a comment": "чтобы оставить комментарий",
    # ── TTY Help ──
    "TTY Terminal Reference": "Справочник TTY-терминала",
    "TTY (Teletype) is an alternative interface for Rugram. All functionality is available through a terminal emulator with commands like": "TTY (Teletype) — альтернативный интерфейс управления Rugram. Весь функционал доступен через эмуляцию терминала с командами",
    "This mode is for those who prefer the keyboard: arrow key history, --help on every command.": "Режим для тех, кто привык к клавиатуре: история стрелками, --help на каждой команде.",
    "Keyboard Shortcuts": "Горячие клавиши",
    "Focus input": "Фокус ввода",
    "Show help": "Показать справку",
    "Command history": "История команд",
    "Autocomplete": "Автодополнение",
    "Blur input": "Снять фокус",
    "Per-command help": "Справка по команде",
    "Params": "Параметры",
    ...
    "System": "Система",
    # ── TTY intro fragments ──
    "Use the": "Используйте кнопку",
    "All commands are in English — type": "Все команды на английском — введите",
    "in the terminal to get started.": "в терминале чтобы начать.",
    # ── TTY command descriptions ──
    "All commands behave like a real Unix terminal: cd, ls, grep, echo, man, history, export and more.": "все команды работают как в реальном Unix-терминале: cd, ls, grep, echo, man, history, export и другие.",
    ...
    "a social network you drive from a terminal. Like, comment, follow, search, and message — all without leaving the command line.": "социальная сеть, которой управляют из терминала. Лайки, комментарии, подписки, поиск и сообщения — не отрываясь от командной строки.",
    "Most social networks are endless feeds, buttons, and popups. Rugram is built for developers — everything is duplicated in the terminal.": "Большинство соцсетей — это бесконечные ленты, кнопки и попапы. Rugram спроектирован для разработчиков — всё продублировано терминалом.",
    "Full TTY terminal emulator in the browser —": "Полноценный эмулятор TTY-терминала в браузере —",
    "GUI on Bootstrap 5.3 styled in Catppuccin — dark/light theme, infinite scroll, animations": "GUI на Bootstrap 5.3 в стиле Catppuccin — тёмная/светлая тема, infinite scroll, анимации",
    "Bilingual UI — English and Russian, switch at any time": "Два языка — английский и русский, переключение в любой момент",
    "Real-time messenger with encryption at rest": "Мессенджер в реальном времени с шифрованием",
    "Push notifications via Web Push API": "Push-уведомления через Web Push API",
    "Image upload, bookmarks, reposts, REST API": "Загрузка изображений, закладки, репосты, REST API",
