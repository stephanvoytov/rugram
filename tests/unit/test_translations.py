...
def test_all_used_keys_have_translations(used_keys: set[str], ru_dict: dict[str, str]) -> None:
...
def test_no_unused_translations(used_keys: set[str], ru_dict: dict[str, str]) -> None:
