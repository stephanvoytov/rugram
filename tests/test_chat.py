...
class TestCreateChat:
    ...
    def test_create_chat_reuses_existing(self, client: FlaskClient, app: Flask) -> None:
...
class TestSendMessage:
    ...
    def test_send_empty_message_fails(self, client: FlaskClient, app: Flask) -> None:
    ...
    def test_send_not_participant(self, client: FlaskClient, app: Flask) -> None:
...
class TestChatList:
    ...
    def test_chat_list_with_conversation(self, client: FlaskClient, app: Flask) -> None:
...
class TestChatMessages:
    ...
    def test_get_messages_not_participant(self, client: FlaskClient, app: Flask) -> None:
...
class TestMessagePersistence:
    ...
    def test_message_is_stored(self, client: FlaskClient, app: Flask) -> None:
    ...
    def test_edit_message(self, client: FlaskClient, app: Flask) -> None:
        ...
        r = client.patch(f"/chat/{chat_id}/messages/{msg_id}", json={"text": "edited"})
        assert r.status_code == 200
        data = r.get_json()
